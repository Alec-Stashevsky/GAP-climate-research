---
title: "05.1 - Regional Emissions Plots (Closest Conf)"
...
```{r Import}
path.in <- "C:/Users/Alec/Documents/GAP Research/GAP Climate Research/Analysis/Regional Analysis/APA Regional Emissions (Closest Conf Analysis).xlsx"
...
pdf(file = paste0(getwd(),"/visualizations/APA Regional Emissions Plots (Closest Conf).pdf"),
  width = 8, height = 6)
