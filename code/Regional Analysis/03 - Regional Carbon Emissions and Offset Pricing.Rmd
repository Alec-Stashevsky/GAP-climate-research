---
title: "03 - Regional Carbon Emissions and Offset Pricing"
...
destination.nyc <- nyc$`Regional Destination`

origins.sf <- sf$IATA
destination.sf <- sf$`Regional Destination`

origins.phl <- phl$IATA
destination.phl <- phl$`Regional Destination`
...
write.xlsx(final.sets,
           file = "C:/Users/Alec/Documents/GAP Research/GAP Climate Research/GeoData/Regional Analysis/APA Regional Emissions.xlsx")
```
