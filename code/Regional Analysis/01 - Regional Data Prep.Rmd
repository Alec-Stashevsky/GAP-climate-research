...
names(min.dists) <- c("NYC", "SF", "PHL")
names(min.conference) <- c("NYC", "SF", "PHL")
...
nyc.final <- data.table(nyc, "CnumMinDistance" = min.dists[[1]],
                        "InternationalConf" = min.conference[[1]])

sf.final <- data.table(sf, "CnumMinDistance" = min.dists[[2]],
                       "InternationalConf" = min.conference[[2]])

phl.final <- data.table(phl, "CnumMinDistance" = min.dists[[3]],
                        "InternationalConf" = min.conference[[3]])
...
nyc.final[is.na(`Regional Destination`)]$`Regional Destination` <- nyc.final[is.na(`Regional Destination`)]$InternationalConf

sf.final[is.na(`Regional Destination`)]$`Regional Destination` <- sf.final[is.na(`Regional Destination`)]$InternationalConf

phl.final[is.na(`Regional Destination`)]$`Regional Destination` <- phl.final[is.na(`Regional Destination`)]$InternationalConf
