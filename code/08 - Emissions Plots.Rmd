...
ggplot(intl.domestic, aes(x = fct_rev(fct_reorder(factor(Destination),
                                          `Total CO2e (Kg)`)),
                          y = intl.domestic$`Total CO2e (Kg)`/1000,
                          fill = `Travel Type`)) +
  geom_col(position="stack") +
  facet_wrap(~`Attendance Base`) +
  xlab("Conference Destination") +
  ylab("Metric Tons CO2 Emissions") +
  coord_flip() +
  ggtitle("Total CO2 Emissions by Travel Type")

# Emissions Share
ggplot(intl.domestic, aes(x = fct_reorder(factor(Destination),
                                          `Emissions Share`),
                          y = `Emissions Share`,
                          fill = `Travel Type`)) +
  ...
  xlab("Conference Destination") +
  coord_flip() +
  ggtitle("CO2 Emissions Share by Travel Type") +
...
ggplot(intl.domestic, aes(x = fct_rev(fct_reorder(factor(Destination),
  ...
  coord_flip() +
  ggtitle("CO2 Emissions per Capita by Travel Type")
